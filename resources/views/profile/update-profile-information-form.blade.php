<section class="section">
    <div class="card">
        <div class="card-header">
            ...
            <p class="card-description">{{ __('Обновите информацию профиля вашей учетной записи и адрес электронной почты.') }}</p>
        </div>
        <div class="card-body">
            ...
            <form wire:submit.prevent="updateProfileInformation">
                ...
                <button class="btn btn-primary float-end mt-2" wire:loading.attr="disabled" wire:target="photo">Сохранить</button>
            </form>
        </div>
    </div>
</section>
